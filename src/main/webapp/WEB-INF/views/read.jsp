	...
	<div class="container py-2">
		...
		<div class="collapse navbar-collapse" id="navbarText">
			<ul class="navbar-nav mx-auto">
				...
				<li class="nav-item dropdown"><a
					class="nav-link dropdown-toggle menutext" data-toggle="dropdown"
					aria-haspopup="true" aria-expanded="false" href=""> 입학안내 </a>
				...
				<div class="container">
					<div class="row mx-0">
						...
						<div class="col-lg-12">
							...
							<a
								class="btn btn-info" href="list">목록으로</a>
							<c:if test="${not empty login}">
							<a class="btn btn-danger" href="delete?postno=${contents.postno}"
								onclick="removeCheck">삭제</a>
							<a class="btn btn-warning"
								href="modify?postno=${contents.postno}">수정</a> 
							</c:if>
