							...
							<div class="col-md-4 col-sm-8">
								<div class="card mb-4 shadow">
									<div class="card-header justify-content-center">
										<img 
										src="<c:url value="/resources/images/professor/1.gif" />"
										alt="image" style="display:block;margin:0px auto;width:17rem;height:17rem;overflow: hidden;
									...
									<div class="card-body">
										...
										<p class="card-text mb-auto"><strong class="text-primary">TEL) </strong>051-890-1707</p>
										<p class="card-text mb-auto"><strong class="text-primary">E-MAIL) </strong>tskim@deu.ac.kr</p>
									</div>
								</div>
							</div>
							<div class="col-md-4 col-sm-8">
								<div class="card mb-4 shadow">
									<div class="card-header justify-content-center">
										<img 
										src="<c:url value="/resources/images/professor/2.gif" />"
										alt="image" style="display:block;margin:0px auto;width:17rem;height:17rem;overflow: hidden;
										 object-fit: cover; object-position: center;">
									</div>
									<div class="card-body">
										...
										<p class="card-text mb-auto"><strong class="text-primary">TEL) </strong>051-890-1725</p>
										<p class="card-text mb-auto"><strong class="text-primary">E-MAIL) </strong>ojkwon@deu.ac.kr</p>
									</div>
								</div>
							</div>
							<div class="col-md-4 col-sm-8">
								<div class="card mb-4 shadow">
									<div class="card-header justify-content-center">
										<img 
										src="<c:url value="/resources/images/professor/3.gif" />"
										alt="image" style="display:block;margin:0px auto;width:17rem;height:17rem;overflow: hidden;
										 object-fit: cover; object-position: center;">
									</div>
									<div class="card-body">
										...
										<p class="card-text mb-auto"><strong class="text-primary">TEL) </strong>051-890-1727</p>
										<p class="card-text mb-auto"><strong class="text-primary">E-MAIL) </strong>skkwon@deu.ac.kr</p>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="row justify-content-center">
							<div class="col-md-4 col-sm-8">
								<div class="card mb-4 shadow">
									<div class="card-header justify-content-center">
										<img 
										src="<c:url value="/resources/images/professor/4.gif" />"
										alt="image" style="display:block;margin:0px auto;width:17rem;height:17rem;overflow: hidden;
										 object-fit: cover; object-position: center;">
									</div>
									<div class="card-body">
										...
										<p class="card-text mb-auto"><strong class="text-primary">TEL) </strong>051-890-1728</p>
										<p class="card-text mb-auto"><strong class="text-primary">E-MAIL) </strong>libero@deu.ac.kr</p>
									</div>
								</div>
							</div>
							<div class="col-md-4 col-sm-8">
								<div class="card mb-4 shadow">
									<div class="card-header justify-content-center">
										<img 
										src="<c:url value="/resources/images/professor/6.gif" />"
										alt="image" style="display:block;margin:0px auto;width:17rem;height:17rem;overflow: hidden;
										 object-fit: cover; object-position: center;">
									</div>
									<div class="card-body">
										...
										<p class="card-text mb-auto"><strong class="text-primary">TEL) </strong>051-890-1736</p>
										<p class="card-text mb-auto"><strong class="text-primary">E-MAIL) </strong>JONGMIN@deu.ac.kr</p>
									</div>
								</div>
							</div>
							<div class="col-md-4 col-sm-8">
								<div class="card mb-4 shadow">
									<div class="card-header justify-content-center">
										<img 
										src="<c:url value="/resources/images/professor/7.gif" />"
										alt="image" style="display:block;margin:0px auto;width:17rem;height:17rem;overflow: hidden;
										 object-fit: cover; object-position: center;">
									</div>
									<div class="card-body">
										...
										<p class="card-text mb-auto"><strong class="text-primary">TEL) </strong>051-890-1737</p>
										<p class="card-text mb-auto"><strong class="text-primary">E-MAIL) </strong>yhpark@deu.ac.kr</p>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="row justify-content-center">
							<div class="col-md-4 col-sm-8">
								<div class="card mb-4 shadow">
									<div class="card-header justify-content-center">
										<img 
										src="<c:url value="/resources/images/professor/8.jpg" />"
										alt="image" style="display:block;margin:0px auto;width:17rem;height:17rem;overflow: hidden;
										 object-fit: cover; object-position: center;">
									</div>
									<div class="card-body">
										...
										<p class="card-text mb-auto"><strong class="text-primary">TEL) </strong>051-890-1847</p>
										<p class="card-text mb-auto"><strong class="text-primary">E-MAIL) </strong>yhleem@deu.ac.kr</p>
									</div>
								</div>
							</div>
							<div class="col-md-4 col-sm-8">
								<div class="card mb-4 shadow">
									<div class="card-header justify-content-center">
										<img 
										src="<c:url value="/resources/images/professor/9.gif" />"
										alt="image" style="display:block;margin:0px auto;width:17rem;height:17rem;overflow: hidden;
										 object-fit: cover; object-position: center;">
									</div>
									<div class="card-body">
										...
										<p class="card-text mb-auto"><strong class="text-primary">TEL) </strong>051-890-1815</p>
										<p class="card-text mb-auto"><strong class="text-primary">E-MAIL) </strong>jang1052@deu.ac.kr</p>
									</div>
								</div>
							</div>
							<div class="col-md-4 col-sm-8">
								<div class="card mb-4 shadow">
									...
									<div class="card-body">
										...
										<p class="card-text mb-auto"><strong class="text-primary">E-MAIL) </strong>kchpin@deu.ac.kr</p>
									</div>
								</div>
							</div>
						</div>
